...
'title-invalid-utf8'             => 'Имя страницы содержит некорректный UTF-8',
'title-invalid-double-interwiki' => 'Двойная интервики-ссылка',
'title-invalid-characters'       => 'Имя страницы содержит запрещённые символы',
'title-invalid-relative'         => 'Имя страницы относительное',
'title-invalid-magic-tilde'      => 'Имя страницы содержит тильды',
'title-invalid-too-long'         => 'Слишком длинное имя страницы',
'title-invalid-leading-colon'    => 'Имя страницы начинается с двоеточия',
'title-invalid-empty-text'            => 'Запрашиваемое название страницы пусто либо включает в себя только имя пространства имён без имени страницы.',
'title-invalid-utf8-text'             => 'В названии страницы запрещена UTF-8 последовательность "$1".',
'title-invalid-double-interwiki-text' => 'Запрашиваемое название страницы представляет собой недопустимую двойную интервики-ссылку.',
'title-invalid-characters-text'       => 'Запрашиваемое название страницы содержит недопустимые символы: "$1" в позиции $2.',
'title-invalid-relative-text'         => 'Относительные (./, ../) названия страниц запрещены, так как могут быть недоступны при обработке таких последовательностей броузером.',
'title-invalid-magic-tilde-text'      => 'Запрашиваемое название страницы содержит запрещённую магическую последовательность тильд (~~~).',
'title-invalid-too-long-text'         => 'Запрашиваемое название страницы слишком длинное. Его длина не должна превышать $1 байт в кодировке UTF-8. Корректное по длине название было бы "$2".',
'title-invalid-leading-colon-text'    => 'Запрашиваемое название страницы содержит запрещённые двоеточия в начале.',
