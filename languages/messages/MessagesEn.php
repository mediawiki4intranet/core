...
'title-invalid-empty-text'            => 'The requested page title is empty or contains only the name of a namespace.',
'title-invalid-utf8-text'             => 'Page title can not contain UTF-8 sequence "$1".',
'title-invalid-double-interwiki-text' => 'The requested page title contains invalid double interwiki link.',
'title-invalid-characters-text'       => 'The requested page title contains invalid characters: "$1" at position $2.',
'title-invalid-relative-text'         => 'Relative page titles (./, ../) are invalid, because they will often be unreachable when handled by user\'s browser.',
'title-invalid-magic-tilde-text'      => 'The requested page title contains invalid magic tilde sequence (~~~).',
'title-invalid-too-long-text'         => 'The requested page title is too long. It must be no longer than $1 bytes in UTF-8 encoding. Page title short enough would be "$2".',
'title-invalid-leading-colon-text'    => 'The requested page title contains an invalid colon at the beginning.',
